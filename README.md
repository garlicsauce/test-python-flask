...
- 🎯 Entry points to execute your program using `python -m <test_python_flask>` or `$ test_python_flask` with basic CLI argument parsing.
...
---
# test_python_flask Flask Application

Awesome test_python_flask created by garlicsauce
...
```bash
git clone https://github.com/garlicsauce/test-python-flask test_python_flask
...
```bash
test_python_flask create-db   # run once
test_python_flask populate-db  # run once (optional)
test_python_flask add-user -u admin -p 1234  # ads a user
test_python_flask run
```
